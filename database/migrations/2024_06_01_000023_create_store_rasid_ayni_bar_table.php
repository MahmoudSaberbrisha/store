...
class CreateStoreRasidAyniBarTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::dropIfExists('store_rasid_ayni_bar');

        Schema::create('store_rasid_ayni_bar', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8';
            ...
            $table->string('sanf_amount', 15)->nullable();
