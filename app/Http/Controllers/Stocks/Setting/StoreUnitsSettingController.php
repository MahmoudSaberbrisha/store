...
class StoreUnitsSettingController extends Controller
{
    ...
    {
        $units = StoreUnitsSetting::all();
        return view('storeunitssetting.index', compact('units'));
    }
    public function create()
    {
        return view('storeunitssetting.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('storeunitssetting.show', compact('unit'));
    }
