...
class StoreBranchSettingController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('storebranchsetting.index', compact('branchsettings'));
    }
    public function create()
    {
        $branches = StoreBranchSetting::all();
        return view('storebranchsetting.create', compact('branches'));
    }
    ...
    public function edit($id)
    {
        ...
        $branches = StoreBranchSetting::all();
        return view('storebranchsetting.edit', compact('branchsetting', 'branches'));
    }
    ...
    public function show($id)
    {
        ...
        return view('storebranchsetting.show', compact('branch'));
    }
