            ...
            <div class="col-md-6 col-lg-4 mb-3">
                <div class="card h-100 shadow-sm p-2">
                    ...
                    <div class="card-footer d-flex justify-content-between py-1 px-2">
                        <a href="{{ route('storebranchsetting.show', $branch->id) }}" class="btn btn-sm btn-info">View</a>
                        <a href="{{ route('storebranchsetting.edit', $branch->id) }}"
                            class="btn btn-sm btn-warning">Edit</a>
                        <form action="{{ route('storebranchsetting.destroy', $branch->id) }}" method="POST"
