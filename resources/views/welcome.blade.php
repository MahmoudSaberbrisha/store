...
<body class="flex flex-col items-center p-4">
    <div class="w-full max-w-4xl  shadow-lg rounded-lg p-6 relative">
        <img alt="خلفية مزخرفة" class="absolute inset-0 w-full h-full object-cover  z-0" src="assets/bg.jpg" />
        <div class="relative z-10">
            {{-- <div
                class="bg-white rounded-full border-4 border-blue-900 p-4 flex items-center space-x-6 rtl:space-x-reverse justify-center mx-auto">
                <div class="text-center" style="padding-right: 20%">
                ...
                <img alt="شعار المجموعات" style="padding-right: 20%" class="rounded-full "
            ...
            <div class="card items-center mb-4 rounded-full">
                ...
                <img src="assets/logo.jpg" alt="صورة" class="moon rounded-full w-32 h-32" />
            </div>
            ...
            <div class="relative bg-red-500 p-4 rounded-lg shadow-lg w-full">
                ...
                <img alt="أوراق درجات" class="absolute bottom-1 right-2 w-48 h-48"
                    style="border-radius: 20px;margin: 10px" src="assets/a.jpg" />
            </div>
