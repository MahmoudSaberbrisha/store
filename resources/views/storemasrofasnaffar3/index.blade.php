            ...
            <div class="col-md-6 col-lg-4 mb-3">
                <div class="card h-100 shadow-sm p-2">
                    <div class="card-header bg-primary text-white py-1 px-2">
                        <a href="{{ route('storemasrofasnaffar3.show', $record->id) }}"
                    ...
                    <div class="card-footer d-flex justify-content-between py-1 px-2">
                        <a href="{{ route('storemasrofasnaffar3.edit', $record->id) }}"
                            class="btn btn-sm btn-warning">Edit</a>
                        <form action="{{ route('storemasrofasnaffar3.destroy', $record->id) }}" method="POST"
