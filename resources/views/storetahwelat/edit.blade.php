...
@section('content')
    ...
    <form action="{{ route('storetahwelat.update', $tahwelat->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="rkm" name="rkm" required
                value="{{ old('rkm', $tahwelat->rkm) }}">
        </div>
        <div class="mb-3">
            <label for="order_date" class="form-label">Order Date</label>
            <input type="date" class="form-control" id="order_date" name="order_date" required
                value="{{ old('order_date', $tahwelat->order_date) }}">
        </div>
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="order_date_ar" name="order_date_ar" maxlength="255"
                value="{{ old('order_date_ar', $tahwelat->order_date_ar) }}">
        </div>
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="order_time" name="order_time" maxlength="50"
                value="{{ old('order_time', $tahwelat->order_time) }}">
        </div>
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="from_storage" name="from_storage" required
                value="{{ old('from_storage', $tahwelat->from_storage) }}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="from_storage_n" name="from_storage_n" maxlength="255"
                value="{{ old('from_storage_n', $tahwelat->from_storage_n) }}">
        </div>
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="to_storage_n" name="to_storage_n" maxlength="255"
                value="{{ old('to_storage_n', $tahwelat->to_storage_n) }}">
        </div>
