...
@section('content')
    <h1>Edit Return Purchases Item</h1>
    ...
    <form action="{{ route('storereturnpurchasesitem.update', $item->id) }}" method="POST"
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="return_purchases_id" name="return_purchases_id" required
                value="{{ old('return_purchases_id', $item->return_purchases_id) }}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="number" step="0.01" class="form-control" id="one_price_buy" name="one_price_buy" required
                value="{{ old('one_price_buy', $item->one_price_buy) }}">
        </div>
        <div class="mb-3">
            ...
            <input type="number" step="0.01" class="form-control" id="return_amount" name="return_amount" required
                value="{{ old('return_amount', $item->return_amount) }}">
        </div>
        <div class="mb-3">
            <label for="price_return_amount" class="form-label">Price Return Amount</label>
            <input type="number" step="0.01" class="form-control" id="price_return_amount" name="price_return_amount"
                required value="{{ old('price_return_amount', $item->price_return_amount) }}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="date_ar" name="date_ar"
                value="{{ old('date_ar', $item->date_ar) }}">
        </div>
        <div class="mb-3">
        ...
        <div class="mt-4 text-center">
            <button type="submit" class="btn btn-primary">Update Return Purchases Item</button>
