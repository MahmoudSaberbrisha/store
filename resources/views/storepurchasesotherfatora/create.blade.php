...
@section('content')
    <h1>Add New Purchases Other Fatora</h1>

    <form action="{{ route('storepurchasesotherfatora.store') }}" method="POST">
        @csrf
        <div class="mb-3">
        ...
        <button type="submit" class="btn btn-primary">Add Purchases Other Fatora</button>
