...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="{{ route('storepurchasesothers.create') }}" class="btn btn-primary">إضافة مشتريات أخرى جديدة</a>
    </div>
            ...
            <div class="col-md-6 col-lg-4 mb-3">
                <div class="card h-100 shadow-sm p-2">
                    <div class="card-header bg-primary text-white py-1 px-2">
                        <a href="{{ route('storepurchasesothers.show', $purchase->id) }}"
                    ...
                    <div class="card-footer d-flex justify-content-between py-1 px-2">
                        <a href="{{ route('storepurchasesothers.edit', $purchase->id) }}"
                            class="btn btn-sm btn-warning">تعديل</a>
                        <form action="{{ route('storepurchasesothers.destroy', $purchase->id) }}" method="POST"
