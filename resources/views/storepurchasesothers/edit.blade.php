...
@section('content')
    ...
    <form action="{{ route('storepurchasesothers.update', $purchase->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control" id="fatora_print_date" name="fatora_print_date"
                value="{{ old('fatora_print_date', $purchase->fatora_print_date) }}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="storage_id_fk" name="storage_id_fk"
                value="{{ old('storage_id_fk', $purchase->storage_id_fk) }}">
        </div>
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="storage_name" name="storage_name"
                value="{{ old('storage_name', $purchase->storage_name) }}">
        </div>
        <div class="mb-3">
            ...
            <input type="number" step="0.01" class="form-control" id="fatora_cost_before_discount"
                ...
                value="{{ old('fatora_cost_before_discount', $purchase->fatora_cost_before_discount) }}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="number" step="0.01" class="form-control" id="fatora_cost_after_discount"
                ...
                value="{{ old('fatora_cost_after_discount', $purchase->fatora_cost_after_discount) }}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="sheek_status" name="sheek_status"
                value="{{ old('sheek_status', $purchase->sheek_status) }}">
        </div>
        <div class="mb-3">
            ...
            <input type="number" step="0.01" class="form-control" id="sheek_value" name="sheek_value"
                value="{{ old('sheek_value', $purchase->sheek_value) }}">
        </div>
        <div class="mb-3">
            ...
            <input type="date" class="form-control" id="recived_date" name="recived_date"
                value="{{ old('recived_date', $purchase->recived_date) }}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="date_ar" name="date_ar"
                value="{{ old('date_ar', $purchase->date_ar) }}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="deport" name="deport"
                value="{{ old('deport', $purchase->deport) }}">
        </div>
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="had_back" name="had_back" required
                value="{{ old('had_back', $purchase->had_back) }}">
        </div>
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="had_back_reason" name="had_back_reason"
                value="{{ old('had_back_reason', $purchase->had_back_reason) }}">
        </div>
        <div class="mb-3">
            ...
            <input type="date" class="form-control" id="had_back_date" name="had_back_date"
                value="{{ old('had_back_date', $purchase->had_back_date) }}">
        </div>
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="had_back_date_s" name="had_back_date_s"
                value="{{ old('had_back_date_s', $purchase->had_back_date_s) }}">
        </div>
        <div class="mb-3">
            ...
            <input type="number" step="0.01" class="form-control" id="had_back_value" name="had_back_value"
                value="{{ old('had_back_value', $purchase->had_back_value) }}">
        </div>
        <div class="mb-3">
            <label for="type" class="form-label">Type</label>
            <input type="text" class="form-control" id="type" name="type"
                value="{{ old('type', $purchase->type) }}">
        </div>
        <button type="submit" class="btn btn-primary">Update Purchases Others</button>
        <a href="{{ route('storepurchasesothers.index') }}" class="btn btn-secondary">Cancel</a>
    </form>
@endsection
