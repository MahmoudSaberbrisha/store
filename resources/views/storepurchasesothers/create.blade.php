...
@section('content')
    ...
    <form action="{{ route('storepurchasesothers.store') }}" method="POST" class="p-4 border rounded shadow-sm">
        @csrf
        <div class="row g-3">
            <div class="col-md-6">
        ...
        <div class="mt-4 text-center">
            ...
            <a href="{{ route('storepurchasesothers.index') }}" class="btn btn-secondary">إلغاء</a>
        </div>
    </form>
